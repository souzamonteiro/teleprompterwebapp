...
# Script to generate all the icons for the Teleprompter Web App PWA

echo "Generating icons for the Teleprompter Web App PWA..."
...
{
  "name": "Teleprompter Web App",
  "short_name": "Teleprompter",
  "start_url": "./index.html",
  "display": "standalone",
  "theme_color": "#3498db",
  "background_color": "#f5f7fa",
  "description": "Display and scroll teleprompter text directly from your browser",
  "icons": [
    {
